 ...
 */
final class Version20250415192937 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD reference_id INT DEFAULT NULL, CHANGE nom nom VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit DROP reference_id, CHANGE nom nom VARCHAR(200) NOT NULL');
    }
}
